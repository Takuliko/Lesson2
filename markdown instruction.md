...
<<<<<<< HEAD
Для того что бы использовать git status, необходимо в папк с репозиторием написать команду *git status*
=======
Просмотрtnm изменениz в файловых системах можно с помощью команды git status.
>>>>>>> status
